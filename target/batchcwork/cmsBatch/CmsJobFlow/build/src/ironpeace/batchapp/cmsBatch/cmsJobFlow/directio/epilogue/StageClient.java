...
public final class StageClient extends AbstractStageClient {
    ...
    @Override protected String getStageOutputPath() {
        return "target/hadoopwork/${execution_id}/cmsBatch/CmsJobFlow/epilogue/directio";
    }
    @Override protected List<StageInput> getStageInputs() {
        List<StageInput> results = new ArrayList<StageInput>();
        Map<String, String> attributes = null;
        attributes = new HashMap<String, String>();
        results.add(new StageInput("target/hadoopwork/${execution_id}/cmsBatch/CmsJobFlow/stage0001/result0-*", 
    ...
    @Override protected List<StageOutput> getStageOutputs() {
        ...
        Map<String, String> attributes = null;
        attributes = new HashMap<String, String>();
        results.add(new StageOutput("cms/output/", NullWritable.class, JoinedModel.class, BridgeOutputFormat.class, 
                attributes));
        return results;
    }
